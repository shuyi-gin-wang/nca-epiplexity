"""
Smoke test for the continuous-NCA prequential probe.

Mirrors scripts/demo_probe_preq.py but on the ASAL-style continuous substrate
...
Smoke config (fast): 16 rules, 64 rollout steps, 2 ICs.

Run from repo root:
    .venv/Scripts/python.exe scripts/demo_probe_preq_continuous.py
"""
import os
import sys
import time
...
def main():
    ...
    print(
        f"Continuous NCA preq smoke test: {NUM_RULES} rules, grid={GRID}, "
