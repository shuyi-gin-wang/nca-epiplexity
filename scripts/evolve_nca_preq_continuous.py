...
Same metric as scripts/train_nca_preq_continuous.py but search via (μ, λ)
...
Run from repo root:
    .venv/Scripts/python.exe scripts/evolve_nca_preq_continuous.py
"""
import os
import sys
import time
...
SIGMA_DECAY = 0.99  # per-generation; sigma ≈ 0.037 by gen 100
SEED = 0
RENDER_STEPS = 8
