...
Builds on evolve_preq_only_jax.py, which converged to a single
'slow drift collapse' attractor at preq_length around 0.294. Adding gzip complexity
...
Run from repo root:
    .venv/Scripts/python.exe scripts/epiplexity/legacy/evolve_gzip_jax.py
"""
import gzip
import io
import os
