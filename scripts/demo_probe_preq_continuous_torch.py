"""
PyTorch / CUDA smoke test for the continuous-NCA prequential probe.

Mirrors scripts/demo_probe_preq_continuous.py but uses utils/nca_torch.py:
...
Smoke config: 16 rules, 64 rollout steps, 2 ICs.

Run from repo root:
    .venv/Scripts/python.exe scripts/demo_probe_preq_continuous_torch.py
"""
import os
import sys
import time
...
def main():
    ...
    print(
        f"Continuous NCA preq (torch) smoke test: {NUM_RULES} rules, grid={GRID}, "
